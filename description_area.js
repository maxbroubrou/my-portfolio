...
function description_area_onWindowResize() {
    //dimensions
    let h = parseInt(window.innerHeight); //931
    let w = parseInt(window.innerWidth  * 0.28); //554
...
export { description_area_onWindowResize };